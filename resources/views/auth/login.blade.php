@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Bejelentkezés')])
...
{{--            </div>--}}
          ...
          <div class="card-body">
            <p class="card-description text-center">{{ __('Jelentkezz be e-mail címed és jelszavad használatával') }}</p>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> {{ __('Emlékezz rám') }}
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg">{{ __('Bejelentkezés') }}</button>
          </div>
        </div>
      </form>
      <div class="row">
